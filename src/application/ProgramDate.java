...
public class ProgramDate {
	...
	public static void main(String[] args)  throws ParseException {
		...
		//Criamos e recebemos a data através do PARSE do objeto formatado
		...
		System.out.println("Definição UTC com Z: " + y3);
		...
		System.out.println("Definição UTC com Z: " +sdf2.format(y3));
		...
		System.out.println("Definição UTC com Z: " +sdf3.format(y3));
